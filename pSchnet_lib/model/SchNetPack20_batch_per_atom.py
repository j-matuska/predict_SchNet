...
class pytorch_lightning_model_wrapper(pytorch_lightning.LightningModule):
    ...
    #     return self.model(inputs, target)
        self.model.get_submodule("output_modules.0").per_atom_output_key = "pa" # it is ignored in some way, but anything other than None is necessary
        self.model.get_submodule("output_modules.0").aggregation_mode = None
